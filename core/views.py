...
class OrderSummaryView(LoginRequiredMixin, View):
    def get(self, *args, **kwargs):
        try:
            ...
            messages.warning(self.request, "You do not have any product on your cart to place an order. continue shopping :)")
            return redirect("/")
...
def remove_from_cart(request, slug):
    ...
    if order_qs.exists():
        ...
        if order.items.filter(item__slug=item.slug).exists():
            ...
            order_item.delete()
            messages.info(request, "This product has been deleted from your cart.")
            return redirect("core:order-summary")
        else:
    ...
    def post(self, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            try:
                ...
                messages.info(self.request, "Your request has been received, you will be contacted via you email.")
